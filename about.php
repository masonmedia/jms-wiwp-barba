            ...
            <div class="offset-lg-2"></div>
                <div class="col-lg-8 d-flex flex-column justify-content-center align-items-center text-center p-5">
                 <div class="wrap py-5 mb-5">
                     <h2 class="headline l-h pb-2" data-aos="fade-down" data-aos-easing="ease-in-out-sine" data-aos-duration="1000">About</h2>
                     <h5 class="text-white text-uppercase pb-2" data-aos="fade-up" data-aos-easing="ease-in-out-sine" data-aos-duration="1500">Workshops in <span class="pink">Wild</span> Places</h5>
                 </div>
             </div>
            <div class="offset-lg-2"></div>
        </div>
     ...
     <div id="sec-1" class="row d-flex text-secondary min-70 m-4 shadow-lg">
       ...
       <div id="sec-2" class="row d-flex text-secondary min-70 m-4 shadow-lg">
           <div class="col-lg-6 bg-img-mongolia min-50 p-0" data-aos="fade" data-aos-easing="ease-in-out-sine" data-aos-duration="1000"></div>
            <div class="col-lg-6 d-flex flex-column justify-content-center align-items-start text-left bg-light min-50 p-5 o-12" data-aos="fade-up" data-aos-easing="ease-in-out-sine" data-aos-duration="1500">
        ...
        <div id="sec-3" class="row d-flex text-secondary min-70 m-4 shadow-lg">
             <div class="col-lg-6 d-flex flex-column justify-content-center align-items-end text-right min-50 p-5 o-12">
                <h2 class="section-title text-uppercase font-weight-bold border border-bottom-0 p-3 m-0 enter-top" data-aos="fade-right" data-aos-easing="ease-in-out-sine" data-aos-duration="1000">About Janice Mason Steeves</h2>
             ...
             <div class="col-lg-6 d-flex flex-column justify-content-end align-items-start text-left bg-img-teaching min-50 p-0 m-0 enter-bottom" data-aos="fade" data-aos-easing="ease-in-out-sine" data-aos-duration="1000"></div>
         </div><!--end row-->
    </div><!--end container-->
</main>
