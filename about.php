            ...
            <div class="offset-lg-2"></div>
                <div class="col-lg-8 d-flex flex-column justify-content-center align-items-center text-center p-5">
                 <div class="wrap py-5 mb-5">
                     <h2 class="headline l-h pb-2 enter-top">About</h2>
                     <h5 class="text-white text-uppercase pb-2 enter-bottom">Workshops in <span class="pink">Wild</span> Places</h5>
                 </div>
             </div>
            <div class="offset-lg-2"></div>
        </div>
