...
<!--banner-->
    ...
    <div role="banner" class="container-fluid bg-light p-0" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="1200">
    ...
    <div class="container-fluid bg-light p-0 py-2">
     <div id="sec-1" class="row d-flex text-secondary min-70 m-3 shadow-lg rounded">
