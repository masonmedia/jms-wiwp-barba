    ...
    <div role="banner" class="container-fluid p-0">
        <div id="sec-1" class="row d-flex text-secondary min-70 m-4 shadow-lg">
            <div class="col-lg-6 d-flex flex-column justify-content-center align-items-end text-right bg-light min-50 p-5 o-12" data-aos="fade-up" data-aos-duration="1500">
                <h2 class="section-title text-uppercase font-weight-bold border border-bottom-0 p-4 m-0 enter-bottom">A Painting Workshop in a Scottish Castle</h2>
         ...
         <div id="sec-4" class="row d-flex text-secondary min-70 m-4 shadow-lg">
            ...
            <div class="col-lg-6 d-flex flex-column justify-content-center align-items-start text-left min-50 p-5 o-12">
               <h2 class="section-title text-uppercase font-weight-bold border border-bottom-0 p-4 m-0 enter-top" data-aos="fade-right" data-aos-duration="1500">Booking + Info</h2>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body bg-cubes p-4">
                         <div class="jumbotron jumbotron-fluid shadow-lg bg-img-scotland-5 p-4 mb-3 animated fadeIn">
                          ...
                          <h5 class="font-weight-bold pb-3 pt-2 border-bottom">Cost</h5>
                          <h5 class="font-weight-bold pb-3 pt-2">
...
<!--                          Cancellation-->
                          ...
                          <p class="pt-3">To register for this trip, please contact Amy at World Wide Quest:</p>
                          <ul class="pb-3">
                              <li>416-633-5666</li>
